...
<html lang="en">
    <head>
        ...
        <title>Dashboard for Management | Khalid Fadlillah</title>
    ...
    <body class="mx-auto" style="max-width: 1900px;">
        ...
        <div id="content">
            <center>
            <div class='tableauPlaceholder' id='viz1703342893079' style='position: relative'>
                <noscript>
                    <a href='#'><img alt='Manajemen ' src='https://public.tableau.com/static/images/Pa/Paymentv1_3/Manajemen/1_rss.png' style='border: none' /></a>
                </noscript>
                <object class='tableauViz' style='display:none;'>
                    <param name='host_url' value='https%3A%2F%2Fpublic.tableau.com%2F' /> 
                    <param name='embed_code_version' value='3' /> 
                    <param name='site_root' value='' />
                    <param name='name' value='Paymentv1_3/Manajemen' />
                    <param name='tabs' value='no' /><param name='toolbar' value='yes' />
                    <param name='static_image' value='https://public.tableau.com/static/images/Pa/Paymentv1_3/Manajemen/1.png' /> 
        ...
        <script type='text/javascript'>                    
            $(document).ready(function () {
                var divElement = $('#viz1703342893079');
                ...
                // console.log($(document).find('#viz-client-container'));
            });
        </script>  
